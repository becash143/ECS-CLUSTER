...
#cloudmap_namespace file
variable "cloudmap_namespace_name" {
  default = "value"
}

#cloudmap-service file
variable "database_service_name" {
  description = "The name of the CloudMap service for the database."
  default     = "value"
}

variable "cloudmap_namespace_id" {
  description = "The ID of the CloudMap namespace."
  default     = "value"
}
variable "backend_service_name" {
  description = "The name of the CloudMap service for the backend."
  default     = "value"
}
variable "frontend_service_name" {
  description = "The name of the CloudMap service for the frontend."
  default     = "value"
}
